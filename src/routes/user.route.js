...
const {getProfile, updateProfile, updateAvatar, getAvatar, getAvatarByName,viewProfileByID,viewFolloweds,viewFollowers} = require('../controllers/user.controller');

const {upload} = require('../middleware/multer.middleware');
router.route('/viewFollowers/:userId').get(viewFollowers);
router.route('/viewFolloweds/:userId').get(viewFolloweds);
